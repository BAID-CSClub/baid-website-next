<template>
  <div class="relative flex section important:py-20 md:flex-row flex-col items-center">
    <div class="absolute left-20px top-0">
      <svg width="56.55765920826161" height="53" viewBox="0 0 56.55765920826161 53" fill="none">
        <defs>
    ...
    <img :src="pageData.principal_avatar" alt="Avatar"
