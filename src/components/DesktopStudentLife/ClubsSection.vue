<template>
  <div id="container" class="my-10 py-5 flex flex-col justify-center items-center bg-gray-200">
    ...
    <div class="flex justify-center items-center w-274">
      <DesktopSwiper autoplay="true" slides="4">
        <swiper-slide v-for="club in pageData.clubs" :key="club" @click="() => {
          ...
          <div class="h-220px aspect-1 items-center justify-center flex flex-col transition-300 hover:shadow-xl"
