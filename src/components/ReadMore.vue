<template>
  <router-link :to="'/' + locale + props.to" class="decoration-none op-80 hover:op-100 active:op-70 transition-opacity">
    <div class="flex items-center w-min">
      <i class="m-r-2 flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30"
          viewBox="0 0 32.99999997656249 32.99999997656255" fill="none">
          <path id="分组 1" fill-rule="evenodd" :style="{ fill: props.color }"
            transform="translate(0 2.3092638912203256e-14)  rotate(0 16.499999988281253 16.499999988281253)" opacity="1"
      ...
      <span class="w-max font-sans tracking-wide" :style="{ color: props.color }">{{ $t('ReadMore') }}</span>
    </div>
  </router-link>
</template>
