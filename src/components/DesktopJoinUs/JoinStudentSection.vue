<template>
  <div class="section font-sans">
    <div>
      <h3 class="text-8">{{ $t('JoinUs.Student.Title') }}</h3>
      <pre v-html="pageData.student"></pre>
      <div class="flex items-center justify-center text-8 m-t-10 py-10 bg-[var(--standard-red)] rd-5 color-white">
        ...
        <div style="flex: 3" class="text-center color-[var(--standard-red)]">
          <div class="bg-white rd-5 p-3" style="display: inline-block" @click="open(pageData.student_portal)">
